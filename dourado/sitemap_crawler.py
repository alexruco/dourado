...
from utils import log_success, log_error, remove_duplicates, normalize_url
...
def crawl_sitemaps(sitemaps, depth=5):
    ...
    Args:
    sitemaps (list): List of initial sitemap URLs to crawl.
    ...
    log_success(f"crawl_sitemaps.py discovered_sitemaps:{discovered_sitemaps}")
    to_crawl = sitemaps[:]
    current_depth = 0
